...
3. **Нет синхронизации** - нужны sync endpoints и handlers для работы с данными
4. **Низкий coverage** - только 3/10 модулей протестированы (требование: 80%+)
...
3. **Миграция user_data таблицы** - для хранения зашифрованных данных (ВЫСОКИЙ ПРИОРИТЕТ)
