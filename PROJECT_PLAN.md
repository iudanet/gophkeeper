...
- **Фаза 2.2:** Модели данных (~40%) - User, CRDTEntry ✅, нет Credential/Text/Binary/Card
...
3. **Низкий coverage** - только 3/10 модулей протестированы (требование: 80%+)
...
2. **Модели данных** (Credential, TextData, BinaryData, CardData) - ВЫСОКИЙ ПРИОРИТЕТ
3. **Миграция user_data таблицы** - для хранения зашифрованных данных
4. Тесты для storage (Фаза 4) - покрыть 80%+
